...
export function Infographics() {
  ...
  return (
    <>
      <Helmet>
        <title>Our Impact | Empowering Vulnerable Communities</title>
        <meta name="description" content="See how Taraji Learning Hub addresses childhood trauma and fills critical mental health gaps through community-led alternative care solutions in Kenya." />
      </Helmet>
      <div className="py-8 md:py-16 bg-white backdrop-opacity-100">
